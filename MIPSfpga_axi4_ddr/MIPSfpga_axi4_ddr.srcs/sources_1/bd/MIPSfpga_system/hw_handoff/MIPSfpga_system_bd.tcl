...
proc create_root_design { parentCell } {
  ...
  # Create instance: WheelController_0, and set properties
  set WheelController_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:WheelController:1.0 WheelController_0 ]
  ...
  connect_bd_net -net MIPS_MicroAptiv_UP_0_HCLK [get_bd_pins MIPS_MicroAptiv_UP_0/HCLK] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins WheelController_0/clk] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axi_uart16550_1/s_axi_aclk]
  ...
  connect_bd_net -net TX_1 [get_bd_ports TX] [get_bd_pins axi_uart16550_1/sin]
  connect_bd_net -net WheelController_0_dir_clk [get_bd_ports dir_clk] [get_bd_pins WheelController_0/dir_clk]
  connect_bd_net -net WheelController_0_dir_enable [get_bd_ports dir_enable] [get_bd_pins WheelController_0/dir_enable]
  connect_bd_net -net WheelController_0_dir_latch [get_bd_ports dir_latch] [get_bd_pins WheelController_0/dir_latch]
  connect_bd_net -net WheelController_0_dir_serial [get_bd_ports dir_serial] [get_bd_pins WheelController_0/dir_serial]
  connect_bd_net -net WheelController_0_wheel [get_bd_ports wheel] [get_bd_pins WheelController_0/wheel]
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins WheelController_0/para] [get_bd_pins axi_gpio_1/gpio_io_o]
  ...
  connect_bd_net -net axi_uart16550_1_sout [get_bd_ports RX] [get_bd_pins axi_uart16550_1/sout]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconcat_1/In6] [get_bd_pins xlconcat_1/In7] [get_bd_pins xlconstant_4/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x10700000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x10500000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs axi_uart16550_1/S_AXI/Reg] SEG_axi_uart16550_1_Reg
